 ...
 * @author Admin
 */
public class ProfileForEmpController implements Initializable {
    ...
    public void Begin(String username) {
        ...
        if (user.getDob() == null) {
            lbl_dob.setText(null);
        } else {
            lbl_dob.setText(user.getDob().toString());
        }
    ...
    private void Update(ActionEvent event) {
        ...
        if (reply == JOptionPane.YES_OPTION) {
            try {
                ...
                userModel.UpdateEmployee(user.getId(), txt_password.getText(), txt_email.getText(), txt_phone.getText());
